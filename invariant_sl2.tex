...
where the integral is taken over $n \in N'(\A) \cap w_s N(\A)w_s^{-1} \bs N'(\A)$. As the name suggests, it intertwines $\III_P(\lambda)$ with $\III_{P'}(s\lambda)$ which is an equivalent way of saying the diagram below commutes. 
\[ \xymatrix{
